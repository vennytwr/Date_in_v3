package com.datein.date_in.views.material_drawer;
...
public class DrawerArrowDrawable extends Drawable {
	...
	/** Draws a line between two {@link com.datein.date_in.views.material_drawer.DrawerArrowDrawable.JoinedPath}s at distance {@code parameter} along each path. */
	...
	/** Paths were generated with at this size for {@link com.datein.date_in.views.material_drawer.DrawerArrowDrawable#PATH_GEN_DENSITY}. */
	 ...
	 * via {@link android.support.v4.widget.DrawerLayout.DrawerListener#onDrawerSlide(View, float)}'s {@code slideOffset} parameter.
	 */
	 ...
	 * {@link com.datein.date_in.views.material_drawer.DrawerArrowDrawable#PATH_GEN_DENSITY}, no scaling needs to be done.
	 */
